...
const handleAddMore = () => {
  ...
  const onSubmitClick = (e) => {
    ...
    if (editIndex !== -1) {
      ...
      updatedEntries[editIndex] = editingValues;
...
const handleClose = () => {
  ...
  return (
    ...
    <div className="container  overflow-auto">
     ...
     <h1 className='text-center  mt-3 mb-3 bg-success py-3 text-white'>Student Record</h1>
     <div className="add-btn mt-2 text-end ">
        <button className='btn btn-primary  m-2' onClick={openModelHandler}>Add Details</button> 
        </div>
